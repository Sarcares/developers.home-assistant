...
If you want to keep your container updated it is necessary to:

1. In your web browswer, go inside the forked reposiroty (e.g., https://github.com/your_username/core)
2. Click on "Synk fork" and then press the "Update branch" button
3. In Visual Studio Code, when your devcontainer is running, check that Home Assistant is stopped
4. Go inside the folder `/workspaces/core`
5. Execute `git pull`

*Beware*: to update the repository you should not changed any "core" file.
